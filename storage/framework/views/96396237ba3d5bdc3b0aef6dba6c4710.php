...
<body class="antialiased text-white min-h-screen font-montserrat ">
    ...
    <section id="section-profil" class="bg-[#A3CCDA] pt-28 pb-20 text-center min-h-screen">
        <div class="max-w-8xl mx-auto px-6 sm:px-8 lg:px-10">
            ...
            <div id="profilContainer" class="flex flex-wrap justify-center gap-8 sm:gap-10 md:gap-12 lg:gap-14">
                ...
                <?php $__currentLoopData = $profiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $profil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        class="bg-white rounded-xl shadow-lg w-60 sm:w-64 p-6 text-center hover:scale-105 transition-transform duration-300">
                        <img src="<?php echo e(asset($profil['gambar'])); ?>" alt="<?php echo e($profil['nama']); ?>"
                            class="w-28 h-28 mx-auto rounded-full object-cover mb-4 shadow-md">
                        <h3 class="text-lg font-semibold text-[#065084] drop-shadow-md"><?php echo e($profil['nama']); ?></h3>
                        <p class="text-sm text-gray-600 mb-4 drop-shadow-sm"><?php echo e($profil['jabatan']); ?></p>
                        <button onclick="openModal(<?php echo e($index); ?>)"
    ...
    <script>
        ...
        function openModal(index) {
            ...
            document.getElementById('modal-gambar').src = "<?php echo e(asset('')); ?>" + p.gambar;
...
<?php /**PATH C:\laragon\www\satu\resources\views/profil.blade.php ENDPATH**/ ?>